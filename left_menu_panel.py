...
class LeftMenuPanel(Panel):
    def __init__(self, button_event_listener):
        ...
        self.position_button.set_css_classes(["button"])
        ...
        self.satellites_button.set_css_classes(["button"])
        ...
        self.satellites_graphic_button.set_css_classes(["button"])
        self.satellites_graphic_button.connect ("clicked", self.on_satellites_graphic_button_pressed)
        self.append(self.satellites_graphic_button)


        self.map_button = Gtk.Button(label="Map")
        self.map_button.set_css_classes(["button"])
    ...
    def on_satellites_graphic_button_pressed(self, button):
        print("satellites graphic button pressed")
